...
namespace API_DragonSushi.Metodos
{
    public class DAO
    {
        ...
        {
            var strQuery = "";
            strQuery += string.Format("CALL spCadastrarUsuario ('{0}','{1}','{2}','{3}','{4}')", 
                                                                vmUsuario.Pessoa.nomePessoa, 
                                                                vmUsuario.Pessoa.telefone, 
                                                                vmUsuario.Pessoa.cpf, 
                                                                vmUsuario.Usuario.login, 
                                                                vmUsuario.Usuario.senha);
